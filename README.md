...
> - Оперативная память: 6ГБ (Для Linux) 8ГБ (Для Illumos sytems) 
> - Операционная система: только на базе ядра Illumos (OmniOS, OpenIndiana) или на базе ядра Linux (Debian,Ubuntu, Linux Mint Fedora Linux)
> - Утилиты: curl, zip и unzip
> - Язык программирования (для разработчиков): Go 1.25 или выше
